...
<h2 class="leading-2 mb-8">
	...
	or a prototype, but you can still add it here. Github repos, websites, apps, etc. are all welcome.
</h2>
		...
		<div class="border-b border-gray-900/10 pb-12">
			...
			<div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
				<div class="sm:col-span-6">
					...
					<span class="text-sm text-gray-400">Add the here the URL of the possible solution. </span>
					<div class="mt-2">
